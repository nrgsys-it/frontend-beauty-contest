  ...
  return (
    <QueryProvider>
      <div className="max-w-4xl mx-auto space-y-10">
        <div>
          <h1 className="text-3xl font-bold text-text mb-2">Libraries Demo</h1>
        ...
        <section>
          ...
          <p className="text-sm text-text-muted mb-4">~49k star - ~49M downloads/week - Client-side cache</p>
          <TanStackQueryDemo />
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-1">3. Motion (Framer Motion) - Animations</h2>
          <p className="text-sm text-text-muted mb-4">~31k star - ~40M downloads/week - Client Component only</p>
          <MotionDemo />
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-1">4. shadcn/ui - Component Library</h2>
          <p className="text-sm text-text-muted mb-4">~78k star - Copy-paste model (not a package) - RSC-first</p>
          <ShadcnDemo />
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-1">5. Zod - Schema Validation</h2>
          <p className="text-sm text-text-muted mb-4">~34k star - ~12M downloads/week - Works everywhere</p>
          <ZodDemo />
        </section>
      </div>
    </QueryProvider>
